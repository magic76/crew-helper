...
final class LiveToolCatalog {
    ...
    static JSONArray build(
        ...
        tools.put(new JSONObject()
                ...
                .put("description",
                        "Create ONE background same-app pending action only when the user explicitly asks to wait for a future on-screen condition and then act or notify. Runtime polls without Gemini staying active. The follow-up is limited to one low-risk TAP/TYPE/BACK/HOME/COMMIT_SEARCH/NOTIFY action. Never use for sending messages, payments, purchases, deletion, account changes, or other high-risk commits. TAP must use a semantic target, never coordinates.")
                .put("parameters", new JSONObject()
                        ...
                        .put("properties", new JSONObject()
                                ...
                                .put("condition_text", new JSONObject()
                                        .put("type", "STRING")
                                        .put("description", "Required for text_appears/text_disappears. Match visible Accessibility text/content description in the current app."))
                                ...
                                .put("interval_seconds", new JSONObject()
                                        .put("type", "INTEGER")
                                        .put("description", "Polling interval, 5–60 seconds; default 5."))
