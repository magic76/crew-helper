    ...
    static JSONArray build(
        ...
        tools.put(new JSONObject().put("name", "send_text").put("description",
                ...
                .put("parameters", new JSONObject().put("type", "OBJECT")
                        .put("properties", new JSONObject()
                                .put("text", new JSONObject().put("type", "STRING")
                                        .put("description", "Message text to submit. For one-shot sends, use the exact text requested by this user turn. During an ACTIVE Conversation Loop wake, generate a concise context-appropriate reply from the new incoming message; no fresh user turn is required.")))
